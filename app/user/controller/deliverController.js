...
angular.module('user')
	.controller('deliverController',
			['logService',
			 ...
			 '$location',
			 "$modal",
			 function(logService, commService, spinService, $scope, $rootScope, orderService, shipmentChangeService, authenticationService, $location, $modal){

	$rootScope.globalTitle = '配送管理';
